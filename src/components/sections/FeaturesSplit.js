          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  I monitor the pool around the clock to make sure that there is maximum uptime possible.
                  </p>
              </div>
              <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  I am constantly staying updated with the newest IOHK releases and updates, and looking for ways to improve the performance.
                  </p>
              </div>
              <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  The clustered and automated stake pool monitoring systems guarantees unbeatable reliability and state-of-the-art security.
                  </p>
              </div>
              <div className={
                classNames(
